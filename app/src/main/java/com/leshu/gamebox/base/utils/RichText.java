 ...
 * <br/> @date：2018/5/23 16:12
 * <br/> @describe：
 * <p>
 * RichText babushka = (RichText)findViewById(R.id.babushka_text);
 * <p>
 ...
 * <br/>================================================
 */
public class RichText extends AppCompatCheckedTextView {
    ...
    private void init() {
        ...
        RichText.DEFAULT_ABSOLUTE_TEXT_SIZE = (int) getTextSize();
    }
